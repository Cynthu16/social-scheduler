...
function Accounts() {
  ...
  const connectedIDs = accounts.map((accounts) => accounts.platform);
    ...
    <div className="space-y-8 max-w-4xl">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-sm">
        ...
        <button
          ...
          className="flex items-center gap-2 px-2 py-2.5 bg-red-500 hover:bg-red-600 text-white rounded-full font-medium transition-all w-full sm:w-auto justify-center"
        >

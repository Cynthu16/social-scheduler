  ...
  return (
    <div className="space-8">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
        <div className="flex items-center justify-between px-6py-4 border-b border-slate-100">
        ...
        {activities.length === 0 ? (
          ...
          <div className="divide-y divide-slate-50">
            {activities.map((activity) => (
              ...
              >
                <div className="size-9 rounded-xl flex items-center justify-center srink-0 mt-0.5 bg-zinc-100 text-zinc-600">

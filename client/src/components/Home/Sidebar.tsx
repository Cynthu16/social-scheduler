  ...
  return (
    ...
    >
        ...
        {navItems.map((item) => {
          ...
          return (
            <NavLink
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded text-sm transition-all duration-150 border ${isActive ? "bg-red-50 text-red-600 border-red-100" : "text-slate-500 hover:bg-slate-500 border-transparent hover:text-slate-700"}`}
            >
              <item.icon
      ...
      <div className="p-4 border-t border-slate-100">
        <div className="flex items-center gap3 p-2 rounded-xl hover-bg-slate-50 transition-colors">

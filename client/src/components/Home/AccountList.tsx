  ...
  if (accounts.length === 0)
    return (
      <div className="bg-white rounded-2xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-center py-20 px-6">
        <div className="size-14 bg-slte-50 rounded-2xl flex items-center justify-center mb-4 border border-slate-100">
        ...
        return (
          ...
          >
            ...
            <button
              ...
              className="ml-2 p-2.5 rounded-lg text-slate-300 group-hover:text-red-500 transition-all"
            >
